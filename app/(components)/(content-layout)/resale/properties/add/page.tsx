  ...
  return (
    <Fragment>
      <div className="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        <div>
          <h1 className="page-title fw-medium fs-20 mb-0">Add Resale Property</h1>
        </div>
        <div className="d-flex align-items-center gap-2 flex-wrap">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0">
              <li className="breadcrumb-item"><a href="#!">Resale</a></li><li className="breadcrumb-item active">Add Property</li>
            </ol>
          </nav>
        </div>
      </div>
              ...
              <div className="table-responsive">
                <SpkTables
                  ...
                  header={[
                    ...
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('name')} style={{cursor: 'pointer'}}>Name <i className="ri-arrow-up-down-line ms-1"></i></div> },
                ...
                >
                    ...
                    <tr key={0}>
                      ...
                      <td>Sample Item 1</td><td>Website</td><td>Agent 1</td><td>Active</td><td>2024-01-15</td>
                      <td>
                    ...
                    <tr key={1}>
                      <td><input className="form-check-input" type="checkbox" /></td>
                      <td>Sample Item 2</td><td>Social Media</td><td>Agent 2</td><td>Inactive</td><td>2024-01-14</td>
                      <td>
                        <div className="hstack gap-2 fs-15">
                          <a className="btn btn-icon btn-sm btn-success-light rounded-pill" href="#!">
                            <i className="ri-eye-line"></i>
...
export default AddResaleProperty