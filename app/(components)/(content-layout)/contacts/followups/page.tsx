  ...
  return (
    <Fragment>
      <div className="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        <div>
          <h1 className="page-title fw-medium fs-20 mb-0">Follow-ups</h1>
        </div>
        <div className="d-flex align-items-center gap-2 flex-wrap">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0">
              <li className="breadcrumb-item"><a href="#!">Contacts</a></li><li className="breadcrumb-item active">Follow-ups</li>
            </ol>
          </nav>
        </div>
      </div>
              ...
              <div className="table-responsive">
                <SpkTables
                  ...
                  header={[
                    ...
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('contact')} style={{cursor: 'pointer'}}>Contact Name <i className="ri-arrow-up-down-line ms-1"></i></div> },
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('type')} style={{cursor: 'pointer'}}>Follow-up Type <i className="ri-arrow-up-down-line ms-1"></i></div> },
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('dueDate')} style={{cursor: 'pointer'}}>Due Date <i className="ri-arrow-up-down-line ms-1"></i></div> },
                ...
                >
                    ...
                    <tr key={0}>
                      ...
                      <td>John Doe</td><td>Phone Call</td><td>2024-01-20</td><td>Agent 1</td><td><SpkBadge variant="" Customclass="badge bg-warning-transparent">Pending</SpkBadge></td>
                      <td>
                    ...
                    <tr key={1}>
                      <td><input className="form-check-input" type="checkbox" /></td>
                      <td>Jane Smith</td><td>Email</td><td>2024-01-18</td><td>Agent 2</td><td><SpkBadge variant="" Customclass="badge bg-success-transparent">Completed</SpkBadge></td>
                      <td>
                        <div className="hstack gap-2 fs-15">
                          <a className="btn btn-icon btn-sm btn-success-light rounded-pill" href="#!">
                            <i className="ri-eye-line"></i>
