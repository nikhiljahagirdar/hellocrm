...
const NotesDashboard: React.FC<NotesDashboardProps> = () => {
    ...
    return (
        <Fragment>
            ...
            <Seo title="Notes Dashboard" />

            <Pageheader title="Notes" currentpage="Notes Dashboard" activepage="Notes Dashboard" />
                            ...
                            <div className="p-3 task-navigation border-bottom border-block-end-dashed">
                                <div className="d-grid">
                                    <SpkButton Buttonvariant="" onClickfunc={handleShow} Customclass="btn btn-primary rounded-pill d-flex align-items-center justify-content-center" data-bs-toggle="modal" data-bs-target="#addtask">
                                        <i className="ri-add-circle-line fs-16 align-middle me-1"></i>Create New Note
                                    </SpkButton>
                                </div>
                                <ul className="list-unstyled task-main-nav mb-0 mt-3">
                                    <li className="px-0 pt-0">
                                        <span className="fs-11 text-muted op-7 fw-medium">Notes</span>
                                    </li>
            ...
            <Modal show={show} onHide={handleClose} centered className="fade" id="create-task" tabIndex={-1}>
                <Modal.Header>
                    <h6 className="modal-title">Create Note</h6>
                ...
                <Modal.Body>
                    <div className="row gy-2">
                        <Col xl={12}>
                            <Form.Label htmlFor="task-name" className="">Note Title</Form.Label>
                            <Form.Control type="text" className="" id="task-name" placeholder="Note Title" />
                        </Col>
                        <Col xl={12}>
                ...
                <Modal.Footer>
                    ...
                    <SpkButton Buttonvariant="primary" Buttontype="button">Add Note</SpkButton>
                </Modal.Footer>
            </Modal>
