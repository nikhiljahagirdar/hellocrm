  ...
  return (
    <Fragment>
      <div className="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        <div>
          <h1 className="page-title fw-medium fs-20 mb-0">Contacted Leads</h1>
        </div>
        <div className="d-flex align-items-center gap-2 flex-wrap">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0">
              <li className="breadcrumb-item"><a href="#!">Leads</a></li><li className="breadcrumb-item active">Contacted</li>
            </ol>
          </nav>
        </div>
      </div>
              ...
              <div className="table-responsive">
                <SpkTables
                  ...
                  header={[
                    ...
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('source')} style={{cursor: 'pointer'}}>Source <i className="ri-arrow-up-down-line ms-1"></i></div> },
                    ...
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('lastContact')} style={{cursor: 'pointer'}}>Last Contact <i className="ri-arrow-up-down-line ms-1"></i></div> },
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('nextFollowup')} style={{cursor: 'pointer'}}>Next Follow-up <i className="ri-arrow-up-down-line ms-1"></i></div> },
                    { title: 'Actions' }
                  ]}
                >
                    ...
                    <tr key={0}>
                      ...
                      <td>Jane Smith</td><td>Referral</td><td>Agent 2</td><td>2024-01-10</td><td>2024-01-17</td>
                      <td>
                    ...
                    <tr key={1}>
                      <td><input className="form-check-input" type="checkbox" /></td>
                      <td>Bob Wilson</td><td>Cold Call</td><td>Agent 1</td><td>2024-01-12</td><td>2024-01-19</td>
                      <td>
                        <div className="hstack gap-2 fs-15">
                          <a className="btn btn-icon btn-sm btn-success-light rounded-pill" href="#!">
                            <i className="ri-eye-line"></i>
