  ...
  return (
    <Fragment>
      <div className="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        <div>
          <h1 className="page-title fw-medium fs-20 mb-0">Closed Leads</h1>
        </div>
        <div className="d-flex align-items-center gap-2 flex-wrap">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0">
              <li className="breadcrumb-item"><a href="#!">Leads</a></li><li className="breadcrumb-item active">Closed</li>
            </ol>
          </nav>
        </div>
      </div>
              ...
              <div className="table-responsive">
                <SpkTables
                  ...
                  header={[
                    ...
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('closedDate')} style={{cursor: 'pointer'}}>Closed Date <i className="ri-arrow-up-down-line ms-1"></i></div> },
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('result')} style={{cursor: 'pointer'}}>Result <i className="ri-arrow-up-down-line ms-1"></i></div> },
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('reason')} style={{cursor: 'pointer'}}>Reason <i className="ri-arrow-up-down-line ms-1"></i></div> },
                    { title: 'Actions' }
                  ]}
                >
                    ...
                    <tr key={0}>
                      ...
                      <td>Eva Green</td><td>Sunrise Apartments</td><td>2024-01-15</td><td><SpkBadge variant="" Customclass="badge bg-success-transparent">Won</SpkBadge></td><td>Deal Closed</td>
                      <td>
                    ...
                    <tr key={1}>
                      <td><input className="form-check-input" type="checkbox" /></td>
                      <td>Frank Miller</td><td>Green Valley</td><td>2024-01-12</td><td><SpkBadge variant="" Customclass="badge bg-danger-transparent">Lost</SpkBadge></td><td>Budget Mismatch</td>
                      <td>
                        <div className="hstack gap-2 fs-15">
                          <a className="btn btn-icon btn-sm btn-success-light rounded-pill" href="#!">
                            <i className="ri-eye-line"></i>
