  ...
  return (
    <Fragment>
      <div className="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        <div>
          <h1 className="page-title fw-medium fs-20 mb-0">Negotiation Leads</h1>
        </div>
        <div className="d-flex align-items-center gap-2 flex-wrap">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0">
              <li className="breadcrumb-item"><a href="#!">Leads</a></li><li className="breadcrumb-item active">Negotiation</li>
            </ol>
          </nav>
        </div>
      </div>
              ...
              <div className="table-responsive">
                <SpkTables
                  ...
                  header={[
                    ...
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('budget')} style={{cursor: 'pointer'}}>Budget Range <i className="ri-arrow-up-down-line ms-1"></i></div> },
                    ...
                    { title: <div className="d-flex align-items-center justify-content-between" onClick={() => handleSort('stage')} style={{cursor: 'pointer'}}>Negotiation Stage <i className="ri-arrow-up-down-line ms-1"></i></div> },
                    { title: 'Actions' }
                  ]}
                >
                    ...
                    <tr key={0}>
                      ...
                      <td>Charlie Brown</td><td>Sunrise Apartments</td><td>₹75L - ₹80L</td><td>Agent 1</td><td><SpkBadge variant="" Customclass="badge bg-warning-transparent">Price Discussion</SpkBadge></td>
                      <td>
                    ...
                    <tr key={1}>
                      <td><input className="form-check-input" type="checkbox" /></td>
                      <td>Diana Prince</td><td>Green Valley</td><td>₹90L - ₹95L</td><td>Agent 2</td><td><SpkBadge variant="" Customclass="badge bg-info-transparent">Terms Review</SpkBadge></td>
                      <td>
                        <div className="hstack gap-2 fs-15">
                          <a className="btn btn-icon btn-sm btn-success-light rounded-pill" href="#!">
                            <i className="ri-eye-line"></i>
...
export default NegotiationLeads