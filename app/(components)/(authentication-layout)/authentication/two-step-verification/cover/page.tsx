...
const Cover: React.FC<CoverProps> = () => {
  ...
  const handleChange = (current: any, next: any, value: any) => {
              ...
              <Card className="custom-card border-0 shadow-none my-4">
                <Card.Body className="p-5">
                      ...
                      <Col xl={12} className="mb-2">
                        ...
                        <div className="form-check mt-3">
                          ...
                          >
                            ...
                            <Link
                              scroll={false}
                              href="/applications/email/mail-app"
                  ...
                  <div className="text-center">
                    <p className="text-danger mt-3 mb-0 fw-medium">
                      <sup>
                        <i className="ri-asterisk"></i>
                      </sup>
                      Keep the verification code private!
                    </p>
                  </div>
                </Card.Body>
              </Card>
